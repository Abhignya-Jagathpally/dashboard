...
//   - 10 layers (was 9): Trajectory and ProteinNet are sequential, not parallel
//   - Explicit parallel grouping with background band (VAE || ESM-2 only)
...
const DiagramPipelineV2 = () => (
  <svg viewBox="0 0 1100 700" role="img" aria-label="ResistanceMap agentic execution DAG">
    <defs>
    ...
    {/* Background */}
    <rect x="0" y="0" width="1100" height="700" fill="url(#bgGrad)" rx="20" />
    ...
    <g fontFamily="IBM Plex Sans, sans-serif" fontSize="10" fill="#5a6b70" letterSpacing="0.1em">
      ...
      <text x="40" y="378">LAYER 4</text>
      <text x="40" y="438">LAYER 5</text>
      <text x="40" y="498">LAYER 6</text>
      <text x="40" y="558">LAYER 7</text>
      <text x="40" y="608">LAYER 8</text>
      <text x="40" y="658">LAYER 9</text>
    </g>

    {/* Parallel band for L2 only */}
    ...
    <g fontFamily="IBM Plex Sans, sans-serif" fill="#1c2628">
      ...
      {/* L4 Trajectory (sequential) */}
      <g>
        <rect x="180" y="360" width="660" height="42" rx="10" fill="url(#seqNode)" stroke="#2c6e6a" />
        <text x="196" y="384" fontSize="13" fontWeight="600">Trajectory (Neural ODE)</text>
        <text x="196" y="397" fontSize="10" fill="#5a6b70">dopri5 solver · calibration + forecast · 3/6/12 month horizons · 4.5 min</text>
      </g>

      {/* L5 ProteinNet GNN (sequential — depends on trajectory) */}
      <g>
        <rect x="180" y="420" width="660" height="42" rx="10" fill="url(#seqNode)" stroke="#2c6e6a" />
        <text x="196" y="444" fontSize="13" fontWeight="600">ProteinNet GNN</text>
        <text x="196" y="457" fontSize="10" fill="#5a6b70">3-layer GAT · 4 heads · 256 hidden · STRING v12 + ESM-2 + trajectory ckpt · 7.9 min</text>
      </g>

      {/* L6 Fusion */}
      <g>
        <rect x="180" y="480" width="660" height="42" rx="10" fill="url(#seqNode)" stroke="#2c6e6a" />
        <text x="196" y="504" fontSize="13" fontWeight="600">Cross-Attention Fusion</text>
        <text x="196" y="517" fontSize="10" fill="#5a6b70">4 modalities × 4 heads · unified 128-D · 5.5 min</text>
      </g>

      {/* L7 Landscape */}
      <g>
        <rect x="180" y="540" width="660" height="42" rx="10" fill="url(#finalNode)" stroke="#a4492f" />
        <text x="196" y="564" fontSize="13" fontWeight="600">Resistance Landscape</text>
        <text x="196" y="577" fontSize="10" fill="#5a6b70">Drug risk · state · top 20 targets · evidential UQ</text>
      </g>

      {/* L8 Validation */}
      <g>
        <rect x="180" y="590" width="660" height="42" rx="10" fill="url(#finalNode)" stroke="#a4492f" />
        <text x="196" y="614" fontSize="13" fontWeight="600">Validation</text>
        <text x="196" y="627" fontSize="10" fill="#5a6b70">Held-out test · SOTA benchmarks · tier audits</text>
      </g>

      {/* L9 Serve */}
      <g>
        <rect x="180" y="640" width="660" height="36" rx="10" fill="#ffffff" stroke="#2c6e6a" strokeDasharray="5 3" />
        <text x="196" y="662" fontSize="12" fontWeight="500">Serve · FastAPI /predict · /predict/trajectory · /targets/&#123;id&#125;</text>
      </g>
    </g>
    ...
    <g stroke="#2c6e6a" strokeWidth="1.75" fill="none" markerEnd="url(#arrow)">
      ...
      <path d="M 320 342 L 320 360" />
      <path d="M 510 402 L 510 420" />
      <path d="M 510 462 L 510 480" />
      <path d="M 510 522 L 510 540" />
      <path d="M 510 582 L 510 590" />
      <path d="M 510 632 L 510 640" />
    </g>

    {/* ---------- Verification lane ---------- */}
    <g>
      <rect x="880" y="100" width="200" height="530" rx="16" fill="#ffffff" stroke="#d7cbb5" />
    ...
    <line x1="840" y1="500" x2="880" y2="340" stroke="#c58a2b" strokeWidth="1.25" strokeDasharray="2 3" />
  </svg>
);
