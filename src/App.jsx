...
import { visualSystem } from './data/visualSystem.js';
  ...
  return (
    <div className="page">
      ...
      <section className="section">
        <SectionHeader
          title="Visual System"
          subtitle="The dashboard uses bespoke vector diagrams inspired by bio-illustration, synaptic pathway maps, and computational notebook aesthetics while remaining fully original and open-source."
        />
        <div className="card-grid">
