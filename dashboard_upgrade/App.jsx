  ...
  return (
    <div className="page">
      ...
      <section id="overview" className="hero">
        <div className="hero-card reveal">
          ...
          <div className="hero-metrics">
            ...
            <div className="metric" style={{ background: 'linear-gradient(180deg, rgba(164,73,47,0.08), rgba(164,73,47,0.02))', border: '1px solid rgba(164,73,47,0.18)' }}>
              <h3>Eval: 2/4 tiers pass</h3>
              <span>Tier B + C failing · 7 critical blockers</span>
            </div>
          </div>
        </div>
      ...
      <section className="section" id="governance">
        <div className="section-header">
          <div>
            <h3 className="section-title">Evaluation Governance — Live Status</h3>
            <p className="section-subtitle">
              Real verdicts from the latest evaluation run. Tier agents adjudicate data, architecture, forecasting,
              and clinical safety claims independently. Click tier cards to expand agent-level verdicts.
            </p>
          </div>
          <div className="badges">
            <span className="badge locked">2 tiers failing</span>
            <span className="badge">7 blockers</span>
          </div>
        </div>
        <EvalGovernancePanel />
      ...
      <footer className="footer">
        <div>ResistanceMap Dashboard · React static build · Last eval: 2026-04-11</div>
